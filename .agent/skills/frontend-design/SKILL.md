...
| [tailwind-patterns.md](tailwind-patterns.md) | ⚪ Optional | Tailwind CSS v4 patterns |
| [resources/design-tokens.json](resources/design-tokens.json) | ⚪ Optional | Brand design tokens |
| [resources/tech-stack.md](resources/tech-stack.md) | ⚪ Optional | Brand tech stack |
| [resources/voice-tone.md](resources/voice-tone.md) | ⚪ Optional | Brand voice & tone |
...
| Web Interface Guidelines | Fetch and audit against Vercel guidelines | Fetch `https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/command.md` then review target files |
...
- [tailwind-patterns.md](tailwind-patterns.md) - Tailwind CSS v4: CSS-first config, container queries, modern patterns
- [resources/design-tokens.json](resources/design-tokens.json) - Brand design tokens (colors, fonts, spacing)
- [resources/tech-stack.md](resources/tech-stack.md) - Brand technology stack constraints
- [resources/voice-tone.md](resources/voice-tone.md) - Brand voice and tone guidelines
...
| Skill | When to Use |
|-------|-------------|
| **frontend-design** (this) | Design principles, brand tokens, Tailwind CSS, and post-code audit |
| **[nextjs-react-expert](../nextjs-react-expert/SKILL.md)** | React/Next.js component patterns and performance |

## Post-Design Audit Workflow

After implementing your design, audit against Vercel Web Interface Guidelines:

1. Fetch fresh guidelines: `https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/command.md`
2. Read the target files to audit
