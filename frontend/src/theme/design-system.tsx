  ...
  const renderPath = () => {
    switch (iconName) {
      case 'pencil':
        return (
          <path
            d="M9.5 1.5a1.415 1.415 0 0 1 2 2L4 11H1.5V8.5L9.5 1.5Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
      ...
      case 'lock':
        return (
          <>
            <rect x="3" y="6" width="10" height="7" rx="1.5" stroke="currentColor" strokeWidth="1.5" />
      ...
      case 'flask':
        return (
          <path
            d="M5 2h6M8 2v4l-5 7a1.5 1.5 0 0 0 1.25 2.25h7.5A1.5 1.5 0 0 0 13 13L8 6"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      case 'bubbles':
        return (
          <>
            ...
            <circle cx="4" cy="4" r="1" stroke="currentColor" strokeWidth="1.5" />
      ...
      case 'factory':
        return (
          <path
            d="M2 14V8l4 3V8l4 3V5l4 3v6H2z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      case 'wrench':
        return (
          <path
            d="M11.5 2.5a3 3 0 0 0-4.24 0L6 3.76l-3.5 3.5a2.5 2.5 0 0 0 3.53 3.53l3.5-3.5 1.25-1.25a3 3 0 0 0 0-4.24zM4.5 9L3 10.5"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      case 'fire':
        return (
          <path
            d="M8 15c3.5 0 6-2.5 6-6 0-3-2-5.5-4-7-1 2.5-3 3-4 4.5C5 5 4 3 4 3c-2 2-3 4.5-3 6.5 0 3.5 3 5.5 7 5.5z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      case 'droplet':
        return (
          <path
            d="M8 14.5c3.5 0 6-2.5 6-6C14 5 8 1.5 8 1.5S2 5 2 8.5c0 3.5 2.5 6 6 6z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      default:
        return (
          <path
            d="M8 2.5L10 6l3.5.5-2.5 2.5.5 3.5-3.5-2-3.5 2 .5-3.5-2.5-2.5 3.5-.5L8 2.5z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
